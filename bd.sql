...
CREATE TABLE IF NOT EXISTS `dicionario`.`Entrada` (
  ...
  CONSTRAINT `FK_Sublema`
    ...
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `FK_Referencia_entrada`
    FOREIGN KEY (`referencia_verbete`)
    REFERENCES `dicionario`.`referencias` (`Cod`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `FK_Traducao`
    ...
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `FK_classe_entrada`
    FOREIGN KEY (`Id_classeGram`)
    REFERENCES `dicionario`.`classeGram` (`Id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `FK_categoria_entrada`
    FOREIGN KEY (`Id_catGram`)
    REFERENCES `dicionario`.`categoriaGram` (`Id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `FK_rubrica_entrada`
    FOREIGN KEY (`rubrica`)
    REFERENCES `dicionario`.`Rubrica` (`Id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
